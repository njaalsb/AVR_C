     ...
     while(1) {
         ...
         if(active_buffer == 1 && k >= NFFT){  
             ...
             for(int l=0;l<out;l++){
                 ...
                 //Calculating the power spectrum
                 pwr = 20*log10(sqrt(cpx_out[l].r * cpx_out[l].r + cpx_out[l].i * cpx_out[l].i));
 
                 // Tegner en linje med høyde 'pwr' for hver iterasjon
                 SSD1306_DrawLine (counter2,counter2,0, pwr);
                 counter2--;
             ...
             SSD1306_UpdateScreen (SSD1306_ADDR);
             memset(cpx_in_2, 0, sizeof cpx_in_2);
